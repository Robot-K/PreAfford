...
if __name__ == '__main__':
    ...
    dir = args.out_folder
    cat_cnt_dict_path = os.path.join(dir, 'cat_cnt_dict.json')
    scene_cnt_dict_path = os.path.join(dir, 'scene_cnt_dict.json')
    ...
    total, max_trial = 0, 0
    cnt_dict = {'succ': 0, 'fail': 0, 'invalid': 0, 'error': 0}
