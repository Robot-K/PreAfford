...
PreAffordis accepted to IROS 2023.
...
## Before start
To train the models, please first go to the `data` folder and download the pre-processed SAPIEN dataset for PreAfford. 

You can click [here](https://cloud.tsinghua.edu.cn/d/b146deb97ea44c6ca26a/) to download all resources.
